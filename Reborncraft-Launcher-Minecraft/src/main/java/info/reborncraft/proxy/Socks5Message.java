...
class Socks5Message extends SocksMessage {
	...
	public Socks5Message(int cmd, java.net.InetAddress ip, int port) {
		super(cmd, ip, port);
	...
	public Socks5Message(java.io.InputStream in) throws java.io.IOException {
		read(in);
	}
